  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        responseText = data.fallbackResponse || "I'm sorry, I encountered an error while processing your message."
      }
                  ...
                  <div className="space-y-2">
                    ...
                    {message.suggestedTasks && message.suggestedTasks.length > 0 && (
                      <div className="bg-orange-50 border border-orange-200 rounded-lg p-3">
                        <p className="text-sm font-medium text-orange-800 mb-2">Suggested Tasks:</p>
                        ...
                        <Button
                          ...
                          onClick={() => addTasksToList(message.suggestedTasks!)}
                        >
