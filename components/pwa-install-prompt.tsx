...
export default function PWAInstallPrompt() {
  ...
  useEffect(() => {
    ...
    if (promptDismissed && Date.now() - Number.parseInt(promptDismissed) < 7 * 24 * 60 * 60 * 1000) {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 z-50 bg-background border rounded-lg shadow-lg p-4 md:left-auto md:w-80">
      ...
      <div className="flex gap-2">
        <Button variant="outline" size="sm" onClick={handleDismiss} aria-label="Dismiss installation prompt">
          Not now
        </Button>
        <Button
          size="sm"
